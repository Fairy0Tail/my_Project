#ifndef CONCURRENT_THREADPOOLS_H
#define CONCURRENT_THREADPOOLS_H
    ...
    namespace concurrent {
        ...
        class ThreadPools {
            ...
            std::function<void(void)> next_job() {
                ...
                std::unique_lock<std::mutex> job_lock(queue_mutex); //unique_lock
        ...
        public:
             ...
             */
            void AddJobs(std::function<void(void)> job) {
                std::lock_guard<std::mutex> guard(queue_mutex);
...
#endif //CONCURRENT_THREADPOOLS_H
